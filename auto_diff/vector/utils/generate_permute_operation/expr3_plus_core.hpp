...
inline expr3<val_type,d1,d2,d3,i1,i2,i3> operator+(
       expr3<val_type,d1,d2,d3,i1,i2,i3> const& Lijk_, 
       expr3<val_type,D1,D2,D3, A, B, C> const& Rijk_){
    ...
    for (std::size_t n1 = 0; n1 < d1; ++n1){
        for (std::size_t n2 = 0; n2 < d2; ++n2){
            ...
            {
                ret_ijk(n1,n2,n3) = Lijk_(n1,n2,n3) + Rijk_(a,b,c);
            }
        }
    }
    return ret_ijk;
