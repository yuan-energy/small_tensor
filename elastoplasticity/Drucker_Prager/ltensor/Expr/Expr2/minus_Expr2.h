...
#ifndef minus_Expr2_H
#define minus_Expr2_H


//#define CHECK_minus_Expr2
...
inline const Expr2 < const minus_Aij < ExprAij, T>, T, i, j >
operator- (const ExprAij  &a)
{
	typedef const minus_Aij < ExprAij, T> ExprObj;
