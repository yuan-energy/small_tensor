...
//                                                                           //
///////////////////////////////////////////////////////////////////////////////
#ifndef Expr3_minus_Expr3_H
#define Expr3_minus_Expr3_H
...
/*!\brief Minus operation between two Expr Objects of rank 3
*	
...
inline const Expr3< const Aijk_minus_Bijk < ExprAijk, ExprBijk , typename promotedType >,
				typename promotedType, i, j, k >
operator-  (const ExprAijk &ExprL, const ExprBijk &ExprR)
{
	typedef const  Aijk_minus_Bijk <  ExprAijk,  ExprBijk , typename promotedType> Expr_Obj;
...
template < class A, class B, class T, class U, char i, char j, char k >
inline const Expr3 < const Aijk_minus_Bijk < ExprAijk,
...
operator-  (const ExprAijk &ExprL, const ExprBikj &ExprR)
{
	...
	typedef const   Aijk_minus_Bijk < ExprAijk, Permuted_Obj, typename promotedType > Expr_Obj;
