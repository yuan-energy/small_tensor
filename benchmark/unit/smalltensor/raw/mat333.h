...
inline __attribute__((always_inline)) __m128 _mm_load3_al_ps(const float *value) {
...
inline __attribute__((always_inline)) __m128 _mm_load3_ul_ps(const float *value) {
