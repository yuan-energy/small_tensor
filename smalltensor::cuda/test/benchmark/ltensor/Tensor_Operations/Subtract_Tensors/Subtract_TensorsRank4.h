...
///////////////////////////////////////////////
// Define SUBTRACTION = A(i,j,k,l)-B(i,j,k,l)
///////////////////////////////////////////////

template < class A, class B, class T>
class Aijkl_minus_Bijkl
{     
	...
	Aijkl_minus_Bijkl (const A &a, const B &b) : objA(a), objB(b)
	{
	...
	friend std::ostream & operator<< (std::ostream & os, const Aijkl_minus_Bijkl & v)
	{
		os << std::endl << "BEGIN:Aijkl_minus_Bijkl =" << &v << std::endl
		<< ", L = "<< (v.objA) 
		<< ", R = " << (v.objB) 
		<< "END.Aijkl_minus_Bijkl " << std::endl;
		return os;
	}
};
