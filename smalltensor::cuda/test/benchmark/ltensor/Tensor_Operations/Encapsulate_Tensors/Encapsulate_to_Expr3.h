...
///////////////////////////////////////////////////////////////
// ENCAPSULATE CLASS of general RANK to CLASS of RANK = 3
///////////////////////////////////////////////////////////////
...
/*! \brief A class used to encapsulate any object that can be indexed
	...
	*	This class encapsulates all kind of Marray objects to rank 3 expressions, even if the Marray Object
...
class Encapsulate_to_Expr3
{
	...
	*	\returns The data at position (N1,N2,N3)
	*/
...
///////////////////////////////////////////////////////////////
// ENCAPSULATE CLASS of RANK = 3 to CLASS of RANK = 3
///////////////////////////////////////////////////////////////

template<class A, class T, class idxObject1, class idxObject2, class idxObject3>
class Encapsulate_to_Expr3<A,T,3,123,idxObject1,idxObject2,idxObject3>
{
	A & TA;
	...
	Encapsulate_to_Expr3(A &a, const idxObject1 &i1, const idxObject2 &i2, const idxObject3 &i3):
						TA(a),index1(i1),index2(i2),index3(i3){}

	T operator()(const int N1,const int N2,const int N3) const
	{
		return TA(index1(N1),index2(N2),index3(N3));
	}
...
///////////////////////////////////////////////////////////////
// ENCAPSULATE CLASS of RANK = 4 to CLASS of RANK = 3
///////////////////////////////////////////////////////////////

template<class A, class T, class idxObject1, class idxObject2, class idxObject3>
class Encapsulate_to_Expr3<A,T,4,123,idxObject1, idxObject2, idxObject3>
{
	A & TA;
	const int N4;
	const idxObject1 &index1;
	...
	public:
	Encapsulate_to_Expr3(A &a, const int NN4, const idxObject1 &i1, const idxObject2 &i2, const idxObject3 &i3 ):
						TA(a), N4(NN4), index1(i1),index2(i2),index3(i3) {}

	T operator()(const int N1,const int N2, const int N3) const
	{
		return TA(index1(N1),index2(N2),index3(N3),N4);
	}
...
//DONE DONE DONE DONE DONE DONE DONE DONE DONE DONE DONE DONE DONE DONE DONE DONE DONE DONE DONE DOEN DONE DONE DONE


template<class A, class T, class idxObject1, class idxObject2, class idxObject4>
class Encapsulate_to_Expr3<A,T,4,124,idxObject1, idxObject2, idxObject4>
{
	A & TA;
	const int N4;
	const idxObject1 &index1;
	...
	public:
	Encapsulate_to_Expr3(A &a, const int NN4, const idxObject1 &i1,const idxObject2 &i2,const idxObject4 &i4):
						TA(a), N4(NN4), index1(i1), index2(i2), index4(i4) {}

	T operator()(const int N1,const int N2, const int N3) const
	{
		return TA(index1(N1),index2(N2),N4,index4(N3));
	}
...
template<class A, class T, class idxObject1, class idxObject3, class idxObject4>
class Encapsulate_to_Expr3<A,T,4,134,idxObject1, idxObject3, idxObject4>
{
	A & TA;
	const int N4;
	const idxObject1 &index1;
	...
	public:
	Encapsulate_to_Expr3(A &a, const int NN4, const idxObject1 &i1, const idxObject3 &i3, const idxObject4 &i4):
						TA(a), N4(NN4), index1(i1), index3(i3), index4(i4) {}

	T operator()(const int N1,const int N2, const int N3) const
	{
		return TA(index1(N1),N4,index3(N2),index4(N3));
	}
...
//DONE DONE DONE DONE DONE DONE DONE DONE WHILE THE WINTER IS NOT THERE





template<class A, class T, class idxObject2, class idxObject3, class idxObject4>
class Encapsulate_to_Expr3<A,T,4,234,idxObject2, idxObject3, idxObject4>
{
	A & TA;
	const int N4;
	...
	public:
	Encapsulate_to_Expr3(A &a, const int NN4, const idxObject2 &i2, const idxObject3 &i3, const idxObject4 &i4):
						TA(a), N4(NN4), index2(i2), index3(i3), index4(i4) {}

	T operator()(const int N1,const int N2, const int N3) const
	{
		return TA(N4,index2(N1),index3(N2),index4(N3));
	}
