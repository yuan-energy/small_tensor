...
public:
	...
	operator()(eindex<i> i_, eindex<j> j_, eindex<k> k_, eindex<l> l_)const{
	...
	operator()(eindex<i> i_, eindex<j> j_, eindex<k> k_, eindex<k/*same*/> l_){
