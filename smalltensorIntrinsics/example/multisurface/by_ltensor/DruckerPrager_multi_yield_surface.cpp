...
//     // int converge_commit_N_active
//     size += sizeof(converge_commit_N_active) ;
//     // int save_iter_N_active 
//     size += sizeof(save_iter_N_active) ;
...
//     // vector<double> yield_size;  
//     size += sizeof(double) * yield_size.size() ;
//     // vector<double> HardingPara; 
//     size += sizeof(double) * HardingPara.size() ;
