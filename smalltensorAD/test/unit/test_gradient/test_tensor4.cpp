...
ad_graph<double> GRAPH;
	...
	obj2(2,2).set_value(3);
	obj3(i,j)= 	obj1(i,j,k,l)*obj2(k,l);
	ASSERT_MSG(obj3(2,2)==6, "tensor4 gradient operator error");
	
	// Test 2
	tensor4<ad_dual<double>,3,3,3,3> obj4(GRAPH,0.);
	obj4(i,j,k,l) = obj3(i,j) / obj2(k,l) ; 
	ASSERT_MSG(obj4(2,2,2,2)==2, "tensor4 gradient operator error");
